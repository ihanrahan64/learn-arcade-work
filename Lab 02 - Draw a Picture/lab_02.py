...
def the_moon(center_x, center_y):
    arcade.draw_circle_filled(center_x, center_y, 50, (180, 180, 180))
    arcade.draw_circle_filled(center_x-25, center_y, 50, arcade.color.DARK_MIDNIGHT_BLUE)
...
the_moon(700, 500-175)
arcade.draw_circle_filled(675, 500-175, 50, (0, 31, 80))
star(532, 300)
star(512, 381)
star(451, 338)
star(600, 350)
