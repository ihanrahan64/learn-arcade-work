...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.physics_engine2 = arcade.PhysicsEngineSimple(self.enemy_sprite, self.wall_list)
    ...
    def enemy_movement(self):
        self.track_x = self.enemy_sprite.center_x - self.player_sprite.center_x
        self.track_y = self.enemy_sprite.center_y - self.player_sprite.center_y

        if self.track_x > 0:
            self.enemy_sprite.center_x -= 2
        else:
            self.enemy_sprite.center_x += 2

        if self.track_y > 0:
            self.enemy_sprite.center_y -= 2
        else:
            self.enemy_sprite.center_y += 2
